...
// proposer::prepare() calls prepare to send prepare RPCs to nodes
...
proposer::prepare(unsigned instance, std::vector<std::string> &accepts,
    ...
    paxos_protocol::preparearg preparearg;
    preparearg.instance = instance;
    preparearg.n = my_n;
...
proposer::accept(unsigned instance, std::vector<std::string> &accepts,
    ...
    // You fill this in for Lab 6
    paxos_protocol::acceptarg acceptarg;
    acceptarg.instance = instance;
    acceptarg.n = my_n;
    acceptarg.v = v;
    bool r = false;
    for (auto &node : nodes) {
...
proposer::decide(unsigned instance, std::vector<std::string> accepts,
                 std::string v) {
    // You fill this in for Lab 6
    paxos_protocol::decidearg decidearg;
    decidearg.instance = instance;
    decidearg.v = v;
    int r;
